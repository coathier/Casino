...
const css = {
  code: "@media only screen and (max-width: 1000px){#show.svelte-131kz29{display:flex;flex-direction:column}}",
  map: null
};
...
<div class="${"flex flex-col items-center"}"><div id="${"show"}" class="${"flex flex-row svelte-131kz29"}"><div class="${"flex flex-col items-center"}">${validate_component(SlotMachine, "SlotMachine").$$render($$result, {}, {}, {})}</div>
