...
var slots_svelte_svelte_type_style_lang = "";
const css = {
...
<div class="${"flex flex-col gap-4 p-6"}"><div class="${"flex flex-row w-full gap-4 show svelte-l1z290"}">${validate_component(SlotItem, "SlotItem").$$render($$result, { slots: slots[0] }, {}, {})}
    ...
    <div class="${"flex flex-row w-full gap-4 show svelte-l1z290"}">${validate_component(SlotItem, "SlotItem").$$render($$result, {
